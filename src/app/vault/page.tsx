    ...
    <div style={{ background: 'var(--washi)', minHeight: '100vh' }}>
      ...
      <main style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto', padding: '0 clamp(1.25rem,5vw,3rem) clamp(3rem,8vw,6rem)' }}>
        ...
        {visibleGroups.filter(g => g.key !== 'japan').map(group => {
          ...
          const seriesMap: Record<string, { key: string; label: string; labelJa: string; slugs: string[] }[]> = {
            ...
            history: [
              { key: 'eventwest', label: 'The Event That Changed The West', labelJa: '西洋を変えた出来事', slugs: ['the-event-that-changed-the-west-01-the-wound-that-became-a-wall', 'the-event-that-changed-the-west-02-the-aesthetics-of-evil', 'the-event-that-changed-the-west-03-the-woman-at-the-front', 'the-event-that-changed-the-west-04-the-word-were-not-allowed'] },
            ],
          }
      ...
      {(activeFilter === 'all' || activeFilter === 'japan') && (() => {
        ...
        const subsections = [
          ...
          { key: 'japanforgot', label: ja ? '日本が忘れた日本' : 'The Japan That Japan Forgot', articles: articles.filter(a => a.category === 'japan' && ['the-japan-that-japan-forgot-01-the-domains-were-different-countries', 'the-japan-that-japan-forgot-02-tatemae-wasnt-always-japanese', 'the-japan-that-japan-forgot-03-the-townsperson-they-forgot', 'the-japan-that-japan-forgot-04-the-prussian-download', 'the-japan-that-japan-forgot-05-confucian-wrapping-prussian-core', 'the-japan-that-japan-forgot-06-the-tradition-that-was-built-yesterday', 'the-japan-that-japan-forgot-07-the-loudest-people-in-the-room', 'the-japan-that-japan-forgot-08-two-groups-in-a-room'].includes(a.slug)), series: true },
        ]
      ...
      {(activeFilter === 'all' || activeFilter === 'triskelion') && (() => {
        ...
        const books = [
          ...
          { key: 'framework', book: 'Book II', label: ja ? '枠組み' : 'The Framework', slugs: ['triskelion-b2-01-from-two-to-three', 'triskelion-b2-02-three-ways-of-being-in-the-world', 'triskelion-b2-03-the-same-discovery', 'triskelion-b2-04-the-mountain-people', 'triskelion-b2-05-the-river-people', 'triskelion-b2-06-the-sea-people', 'triskelion-b2-07-how-trust-works', 'triskelion-b2-07b-what-each-pole-does-in-hard-times', 'triskelion-b2-07c-all-three-in-the-same-crisis', 'triskelion-b2-08-counterfeit-and-defection', 'triskelion-b2-09-the-three-microcosms', 'triskelion-b2-10-the-three-sacred-objects', 'triskelion-b2-11-the-mitsudomoe', 'triskelion-b2-12-the-goddess-in-heaven', 'triskelion-b2-13-the-balance', 'triskelion-b2-14-the-world-today'] },
          ...
          { key: 'world', book: 'Book IV', label: ja ? '世界' : 'The World', slugs: ['triskelion-b4-01-the-pattern', 'triskelion-b4-02-the-agricultural-rupture', 'triskelion-b4-03-the-near-eastern-pattern', 'triskelion-b4-04-rome-and-the-celts', 'triskelion-b4-05-whitby-and-nara', 'triskelion-b4-06-arthur-and-the-kojiki', 'triskelion-b4-07-chinas-three-poles', 'triskelion-b4-08-the-fragmented-sea', 'triskelion-b4-09-the-axial-age', 'triskelion-b4-10-the-twentieth-century', 'triskelion-b4-11-the-medieval-three-poles', 'triskelion-b4-12-the-secular-inheritance'] },
          { key: 'now', book: 'Book V', label: ja ? '今' : 'Now', slugs: ['triskelion-b5-01-the-three-poles-as-personal-states', 'triskelion-b5-02-the-difficult-conversation', 'triskelion-b5-03-the-three-poles-in-relationships-and-work', 'triskelion-b5-04-the-three-poles-and-crisis', 'triskelion-b5-05-the-empty-altar', 'triskelion-b5-06-when-saviours-turn-to-enemies', 'triskelion-b5-07-three-saviours', 'triskelion-b5-08-the-three-sins', 'triskelion-b5-09-the-gender-revolution-as-hime-hiko-return', 'triskelion-b5-10-the-green-movement-as-mountain-people-return', 'triskelion-b5-11-the-balance', 'triskelion-b5-12-can-the-synthesis-hold'] },
        ]
