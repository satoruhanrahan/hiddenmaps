    ...
    <div style={{ background: 'var(--washi)', minHeight: '100vh' }}>
      ...
      {(activeFilter === 'all' || activeFilter === 'triskelion') && (() => {
        ...
        const books = [
          ...
          { key: 'now', book: 'Book V', label: ja ? '今' : 'Now', slugs: ['triskelion-b5-01-the-three-poles-as-personal-states', 'triskelion-b5-02-the-difficult-conversation', 'triskelion-b5-03-the-three-poles-in-relationships-and-work', 'triskelion-b5-04-the-three-poles-and-crisis', 'triskelion-b5-05-the-gender-revolution-as-hime-hiko-return', 'triskelion-b5-06-the-green-movement-as-mountain-people-return', 'triskelion-b5-07-the-balance', 'triskelion-b5-08-can-the-synthesis-hold'] },
        ]
