            ...
            <div style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto', padding: '6rem 3rem' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.8fr', gap: '5rem', alignItems: 'start' }}>
                    ...
                    <div className="reveal" style={{ position: 'sticky', top: '8rem' }}>
                        <svg style={{ width: '100%', maxWidth: 180, opacity: 0.08, marginBottom: '2rem' }}
                        ...
                        <div style={{
                            ...
                            textTransform: 'uppercase', color: 'var(--rust)', display: 'flex', alignItems: 'center', gap: '0.8rem', marginBottom: '1.5rem',
                        }}>
                            About
                            <span style={{ width: 50, height: 1, background: 'var(--rust)', display: 'block' }} />
                        </div>
                        <h2 style={{ fontFamily: "'Cinzel', serif", fontSize: '1.9rem', fontWeight: 400, lineHeight: 1.2 }}>
                            What is a Hidden Map?
                        </h2>
                    </div>
                    ...
                    <div className="reveal reveal-delay-1">
                        ...
                        <div style={{
                            ...
                            AI-Authored · Human Curated · Openly Stated
                        </div>
                    </div>
                </div>
            </div>
