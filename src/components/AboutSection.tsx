            ...
            <div style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto', padding: 'clamp(3rem, 8vw, 6rem) clamp(1.25rem, 5vw, 3rem)' }}>
                <div className="about-grid">
                    ...
                    <div className="reveal reveal-delay-1" style={{ fontFamily: ja ? "'Noto Serif JP', serif" : 'inherit' }}>
                        {ja ? (
                            <>
                                <p style={{ fontSize: 'clamp(0.95rem, 2vw, 1.05rem)', color: 'var(--deep-sepia)', fontStyle: 'italic', lineHeight: 1.85, marginBottom: '1.6rem' }}>
                                ...
                                <div style={{ borderLeft: '2px solid var(--gold)', paddingLeft: '1.25rem', margin: '2rem 0', fontSize: 'clamp(0.95rem, 2vw, 1.1rem)', fontStyle: 'italic', color: 'var(--deep-sepia)', lineHeight: 1.7 }}>
                                    「世界を形づくるものの多くは表面には現れない。見せてもらえない地図こそが、しばしば最も重要なものだ。」
                                </div>
                                <p style={{ fontSize: 'clamp(0.95rem, 2vw, 1.05rem)', color: 'var(--deep-sepia)', fontStyle: 'italic', lineHeight: 1.85 }}>
                                    Hidden Mapsは
                        ...
                        <div style={{
                            display: 'inline-flex', alignItems: 'center', gap: '0.7rem', marginTop: '1.5rem',
