...
export default function Hero() {
    ...
    return (
        <section style={{
            ...
            <svg style={{ position: 'absolute', right: -80, top: '50%', transform: 'translateY(-50%)', width: 500, height: 500, opacity: 0.07 }}
            ...
            <div style={{ position: 'relative', zIndex: 2, maxWidth: 1200, margin: '0 auto', width: '100%' }}>
                <div style={{
                    fontFamily: "'DM Mono', monospace", fontSize: '0.62rem', letterSpacing: '0.35em',
                    textTransform: 'uppercase', color: 'var(--gold)', marginBottom: '2rem',
                    display: 'flex', alignItems: 'center', gap: '1rem', animation: 'fadeUp 1s ease both',
                }}>
                ...
                <h1 style={{
                    fontFamily: "'Cinzel', serif", fontSize: 'clamp(3.8rem, 10vw, 9rem)',
                    fontWeight: 400, lineHeight: 0.92, color: 'var(--parchment)',
                    marginBottom: '0.1em', animation: 'fadeUp 1s 0.1s ease both',
                }}>
                    Hidden<br />
                ...
                <p style={{
                    ...
                    color: 'rgba(244,240,230,0.45)', maxWidth: 480,
                    marginTop: '2.5rem', marginBottom: '3rem', lineHeight: 1.75,
                ...
                <div style={{ display: 'flex', gap: '1.5rem', animation: 'fadeUp 1s 0.3s ease both' }}>
                    <Link href="#articles" style={{
                        fontFamily: "'DM Mono', monospace", fontSize: '0.65rem', letterSpacing: '0.22em',
                        textTransform: 'uppercase', color: 'var(--ink)', background: 'var(--gold)',
                        padding: '1rem 2.4rem', transition: 'background 0.2s',
                    }}>
                    ...
                    <Link href="#projects" style={{
                        ...
                        border: '1px solid rgba(244,240,230,0.15)', padding: '1rem 2.4rem',
            ...
            <div style={{ position: 'absolute', bottom: '3rem', right: '3rem', zIndex: 2 }}>
                <div style={{ border: '1px solid rgba(201,146,42,0.2)', padding: '1.2rem 1.5rem', display: 'inline-block' }}>
                    <div style={{
                        fontFamily: "'DM Mono', monospace", fontSize: '0.55rem', letterSpacing: '0.3em',
                        textTransform: 'uppercase', color: 'var(--gold)', marginBottom: '0.8rem',
                        borderBottom: '1px solid rgba(201,146,42,0.2)', paddingBottom: '0.5rem',
                    }}>{ja ? '凡例' : 'Legend'}</div>
                    {[
                        { label: ja ? '記事' : 'Articles', color: 'var(--gold)' },
                        { label: ja ? 'インタラクティブツール' : 'Interactive Tools', color: 'var(--rust)' },
                        { label: ja ? '開発中' : 'In Development', color: 'rgba(244,240,230,0.2)' },
                    ].map(({ label, color }) => (
                        <div key={label} style={{
                            fontFamily: "'DM Mono', monospace", fontSize: '0.55rem', letterSpacing: '0.1em',
                            color: 'rgba(244,240,230,0.3)', lineHeight: 2,
                            display: 'flex', alignItems: 'center', gap: '0.6rem', justifyContent: 'flex-end',
                        }}>
                            <span>{label}</span>
